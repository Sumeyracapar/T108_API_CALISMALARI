...
// Class icinde 3 Test metodu olusturun ve asagidaki testleri yapin
    ...
    */
    ...
    public void get01() {
        ...
        1-  https://restful-booker.herokuapp.com/booking endpointine bir GET
        request gonderdigimizde donen response’un status code’unun 200 oldugunu
        ve Response’ta 17  booking id'ye sahip  oldugunu test edin
     */
    ...
    */
       ...
       // url hazirla
       specHerokuApp.pathParams("a", "booking").queryParam("firstname", "Eric");
       ...
       response.then()
               .assertThat()
               .statusCode(200)
               .body("bookingid",Matchers.greaterThanOrEqualTo(1)); // 1den daha büyük ya da eşit demek
   }
